...
#' Draw growth curves
#'
#' Plot growth curve of genome estimation
#'
#'
#' @param data Estimation results data generated by the APAV "pavSize" tool.
#' @param chart_type A character string of chart type. It should be one of "errorbar", "jitter" and "ribbon".
#' @param data_type The type of data displayed. It should be "total" or "increasing".
#'
...
plot_size <- function(
  ...
  data_type <- match.arg(data_type, choices = c("total", "increasing"))
